            ...
            <div class="row" style="background-color: black; height: 75px;">
                ...
                <div class="col-md-12">
                    ...
                    <div class="nav_bar">
                        ...
                        <a href="{{url('')}}"><img src="{{asset('images/logo/mainlogo.png')}}" alt="" id="mlogo"></a>
                    ...
                    <div class="row">
                        <div class="col-lg-12" id="prf">
                            <div class="hello">
                                <h2>Hello,</h2>
                                <br>
                                <span class="name">{{session()->get('user_name')}}</span>
                                ...
                                <div class="menus">
                                    <nav class="mainNavbar">
                                        <ul class="nav navbar-nav" id="menu">
                                            ...
                                            <a href="{{url('userprofileedit')}}"><li class="menul" id="m2">Personal Details</li></a>
